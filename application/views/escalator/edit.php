...
<?php echo form_open('escalator/edit/'.$escalator['id'],array("class"=>"form-horizontal")); ?>
	...
	<div class="form-group">
		<label for="product_supportor" class="col-md-4 control-label">Product Supportor</label>
		<div class="col-md-8">
	...
	<div class="form-group">
		<label for="product_contact" class="col-md-4 control-label">Product Contact</label>
		<div class="col-md-8">
	...
	<div class="form-group">
		<label for="product_service" class="col-md-4 control-label">Product Service</label>
		<div class="col-md-8">
	...
	<div class="form-group">
		<label for="product_serviceman" class="col-md-4 control-label">Product Serviceman</label>
		<div class="col-md-8">
	...
	<div class="form-group">
		<label for="product_nextcheck" class="col-md-4 control-label">Product Nextcheck</label>
		<div class="col-md-8">
	...
	<div class="form-group">
		<label for="p_contract" class="col-md-4 control-label">P Contract</label>
		<div class="col-md-8">
	...
	<div class="form-group">
		<label for="p_customer" class="col-md-4 control-label">P Customer</label>
		<div class="col-md-8">
	...
	<div class="form-group">
		<label for="p_type" class="col-md-4 control-label">P Type</label>
		<div class="col-md-8">
	...
	<div class="form-group">
		<label for="p_stepwidth" class="col-md-4 control-label">P Stepwidth</label>
		<div class="col-md-8">
	...
	<div class="form-group">
		<label for="p_stepangle" class="col-md-4 control-label">P Stepangle</label>
		<div class="col-md-8">
	...
	<div class="form-group">
		<label for="p_maxspeed" class="col-md-4 control-label">P Maxspeed</label>
		<div class="col-md-8">
	...
	<div class="form-group">
		<label for="p_high" class="col-md-4 control-label">P High</label>
		<div class="col-md-8">
	...
	<div class="form-group">
		<label for="p_dragtype" class="col-md-4 control-label">P Dragtype</label>
		<div class="col-md-8">
	...
	<div class="form-group">
		<label for="p_controlscreen" class="col-md-4 control-label">P Controlscreen</label>
		<div class="col-md-8">
	...
	<div class="form-group">
		<label for="p_date" class="col-md-4 control-label">P Date</label>
		<div class="col-md-8">
